...
if (!function_exists('getOtpExpirationTime')) {
    function getOtpExpirationTime()
    {
        $expiration = GeneralSetting::where('key', 'otp_expiration_time')->value('value');
        return $expiration !== null ? $expiration : 2; // default to 2 minutes if not set
    }
}
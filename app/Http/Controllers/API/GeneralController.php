...
class GeneralController extends Controller
{
    ...
    public function getGeneralSettings()
    {
        ...
        $settings = [
            ...
            'isOtp' => $query->where('key', 'email_otp_verified')->first()->value ?? 0,
            'otpExpirationTime' => $query->where('key', 'otp_expiration_time')->first()->value ?? 2,
        ];
    ...
    public function updateGeneralSettings(Request $request)
    {
        $validator = $request->validate([
            ...
            'otpExpirationTime' => 'required_if:otpEmailVerified,true|integer|min:1|max:60',
        ]);
        ...
        GeneralSetting::updateOrCreate(['key' => 'email_otp_verified'], ['display_name' => 'Email OTP Verified', 'value' => $request->otpEmailVerified]);
        GeneralSetting::updateOrCreate(['key' => 'otp_expiration_time'], ['display_name' => 'OTP Expiration Time (Minutes)', 'value' => $request->otpExpirationTime]);

    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            activity()
                ...
                ->withProperties([
                    'name' => "",
                    'code' => '[' . config('config.quotationPrefix') . '-' . $code . ']',
                    'event' => 'Create',
                    'slug' => $quotation->slug,
                    'routeName' => 'quotations.show'
                ])
                ->useLog('Quotation Created')
                ->log('Quotation Created');
    ...
    public function update(Request $request, $slug)
    {
        ...
        try {
            ...
            activity()
                ...
                ->withProperties([
                    'name' => "",
                    'code' => '[' . config('config.quotationPrefix') . '-' . $quotation->quotation_no . ']',
                    'event' => 'Update',
                    'slug' => $quotation->slug,
                    'routeName' => 'quotations.show'
                ])
                ->useLog('Quotation Updated')
                ->log('Quotation Updated');

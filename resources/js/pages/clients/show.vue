            ...
            <div class="card">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li v-if="allData.alternativePhoneNumber" class="list-group-item">
                    <strong>{{ $t("Alternative Contact") }}</strong>
                    <span class="float-right">{{ allData.alternativePhoneNumber }}</span>
                  </li>
                  <li class="list-group-item">
                  ...
                  <li
                    v-if="allData.websiteUrl"
                    class="list-group-item"
                  >
                    <strong>{{ $t("Website URL") }}</strong>
                    <span class="float-right">{{
                      allData.websiteUrl
                    }}</span>
                  </li>

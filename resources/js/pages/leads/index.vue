    ...
    <div class="row">
      <div class="col-lg-12" v-if="$can('lead-list')">
        <div class="card custom-card w-100">
          ...
          <!-- Header -->
          <div class="card-header setings-header d-flex justify-content-between">
                ...
                <tbody>
                  <tr v-for="(lead, i) in items" :key="lead.slug">
                    ...
                    <td>
                      <router-link
                        v-if="$can('lead-view')"
                        :to="{ name: 'leads.show', params: { slug: lead.slug } }"
                      >
                        {{ lead.name }}
                      </router-link>
                    ...
                    <td>
                      <span v-if="lead.status === 'New'" class="badge bg-primary">New</span>
                      <span v-else-if="lead.status === 'In Progress'" class="badge bg-warning">
                        In Progress
                      </span>
                      <span v-else-if="lead.status === 'Converted'" class="badge bg-success">
                        Converted
                      </span>
...
<a
  v-if="$can('lead-convert') && lead.status !== 'Converted'"
  class="btn btn-success btn-sm"
  @click.prevent="convertLead(lead.slug)"
>
  <i class="fas fa-check-circle" />
</a>
                        <router-link
                          v-if="$can('lead-edit')"
                          :to="{ name: 'leads.edit', params: { slug: lead.slug } }"
          ...
          <div class="card-footer">
            <div class="dtable-footer d-flex justify-content-between align-items-center">

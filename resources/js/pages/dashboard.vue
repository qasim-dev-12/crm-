              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-6">
                  <div class="small-box bg-info">
                    <div class="inner">
                      <h3>
                        {{ dashboardSummery.totalStockValue | withCurrency }}
                      </h3>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                ...
                <a href="#" class="badge badge-info ml-2" v-tooltip="$t('Payment Sent = Supplier Payment + Loan Payment <br/> Payment Received = Client Payment + Loan Received')">
                  <i class="fas fa-info"></i>
                </a>
              </h3>
            </div>

          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select id="decimal_places" v-model.number="form.decimal_places"
                  class="form-control" :class="{ 'is-invalid': form.errors.has('decimal_places') }"
                  name="decimal_places">
              ...
              <div class="form-group">
                ...
                <select id="format" v-model="form.format"
                  ...
                  name="format">
                  <option v-for="f in formatOptions" :key="f.value" :value="f.value">
                    {{ f.label }}
                  </option>
                </select>
...
export default {
  ...
  methods: {
    ...
    async getCurrency() {
      ...
      this.form.decimal_places = data.data.decimal_places;
      this.form.format = data.data.format;

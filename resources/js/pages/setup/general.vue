            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="companyName">{{ $t("Company Name") }}
  ...
  " />
              ...
              <div class="row">
                ...
                <div class="form-group col-md-12 mt-2">
                  <toggle-button v-model="form.otpEmailVerified" />
                  {{ $t("Email OTP Verification") }}
                </div>
                <div class="form-group col-md-12" v-if="form.otpEmailVerified">
                  <label for="otpExpirationTime">{{ $t("OTP Expiration Time (Minutes)") }} <span class="required">*</span></label>
                  <input id="otpExpirationTime" v-model.number="form.otpExpirationTime" type="number" min="1" max="60" class="form-control" :class="{ 'is-invalid': form.errors.has('otpExpirationTime') }" name="otpExpirationTime" :placeholder="$t('Enter OTP expiration time in minutes')" />
                  <has-error :form="form" field="otpExpirationTime" />
                </div>
              </div>
            </div>
  ...
  methods: {
    ...
    assignValues() {
      if (this.appInfo) {
        ...
        this.form.otpEmailVerified = this.appInfo.isOtp == 1 ? true : false;
        this.form.otpExpirationTime = this.appInfo.otpExpirationTime;
      }
    },

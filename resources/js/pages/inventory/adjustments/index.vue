        ...
        <div class="card custom-card w-100">
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="/inventory-adjustments/pdf" v-tooltip="$t('Export to PDF')" class="btn btn-secondary">
          ...
          <div class="card-body position-relative">
            <div class="row">
              ...
              <div class="card-tools col-md-3 col-xl-2 mb-2">
                <select
                  v-model="filterType"
                  class="form-control"
                  id="filterType"
              ...
              <div class="col-md-3 col-xl-6 mb-2 text-right">
                ...
                <tbody>
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td v-if="$can('adjustment-edit') ||
                        ...
                        " class="text-right no-print">
                      <div class="btn-group">
                        <router-link v-if="$can('adjustment-view')" v-tooltip="$t('View')" :to="{
                          name: 'adjustments.show',
                          params: { slug: data.slug },
                        }" class="btn btn-primary btn-sm">
                          <i class="fas fa-eye" />
                        </router-link>
                        <router-link v-if="$can('adjustment-edit')" v-tooltip="$t('Edit')" :to="{
                          name: 'adjustments.edit',
                          params: { slug: data.slug },
                        }" class="btn btn-info btn-sm">
                          <i class="fas fa-edit" />
                        </router-link>
                        <a v-if="$can('adjustment-delete')" v-tooltip="$t('Delete')" href="#"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("Inventory Adjustments") };
  },
  components: {
    DateRangePicker,
  },

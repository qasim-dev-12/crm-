                  ...
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    <td>
                      <span
                        ...
                        v-tooltip="$t('Stock is less than alert qty!')"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("Non Zero Inventory") };
  },
  data: () => ({
    breadcrumbsCurrent: "Non Zero Inventory",
    breadcrumbs: [
      {
        name: "Dashboard",
        url: "home",

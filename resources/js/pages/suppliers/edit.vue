          ...
          <form role="form" @submit.prevent="updateSupplier" @keydown="form.onKeydown($event)">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  <label for="alternativePhoneNumber">{{ $t('Alternative Contact') }}</label>
                  <input id="alternativePhoneNumber" v-model="form.alternativePhoneNumber" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('alternativePhoneNumber') }" name="alternativePhoneNumber"
                    :placeholder="$t('Enter a contact number')" />
                  <has-error :form="form" field="alternativePhoneNumber" />
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input id="websiteUrl" v-model="form.websiteUrl" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('websiteUrl') }" name="websiteUrl"
                    :placeholder="$t('Enter website url')" />
                  <has-error :form="form" field="websiteUrl" />
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    async getSupplier() {
      ...
      this.form.alternativePhoneNumber = data.data.alternativePhoneNumber
      this.form.companyName = data.data.companyName
      this.form.websiteUrl = data.data.websiteUrl

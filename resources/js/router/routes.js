...
export default [
  ...
  },
  {
    ...
    component: page("auth/otp_page.vue")
  },
  {
    path: "/register",
    name: "register",
...

  {
    path: "/addons",
    name: "addons",
    component: page("addons/index.vue"),
  ...
  path: '/leads',
  name: 'leads.index',
   component: page("leads/index.vue"),
  meta: { permissions: ['lead-list'] }
},
{
  path: '/leads/create',
  name: 'leads.create',
  component: page("leads/create.vue"),
   meta: { permissions: ['lead-create'] }
},

{
  path: '/leads/:slug',
  name: 'leads.show',
 component: page("leads/show.vue"),
  meta: { permissions: ['lead-view'] }
},
{
  path: '/leads/edit/:slug',
  name: 'leads.edit',
  ...
  // application update routes
  {
    ...
    component: page("application/index.vue"),
    meta: {
  ...
  // woocommerce addon not active
  {
    path: "/woocommerce-addon-not-active",
    name: "woocommerce-addon-not-active",
    component: page("woocommerce-addon-not-active.vue")
  },

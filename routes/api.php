...
use App\Http\Controllers\API\AddonManager;
use App\Http\Controllers\API\ApplicationManagementController;
...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    // Service Types (for Leads dropdown)
Route::get('/service-types', [ServiceTypeController::class, 'index']);
    ...
    Route::get('/leads/{slug}', [LeadsController::class, 'show']);
    Route::put('/leads/{slug}', [LeadsController::class, 'update']);
    ...
    Route::post('/activity-log/delete', [ActivityLogController::class, 'delete']);


    // woocommerce
    Route::post('/install/woocommerce', [AddonManager::class, 'installWooCommerce']);
    Route::post('/manage/woocommerce/addon', [AddonManager::class, 'manageWooCommerceAddon']);
});
